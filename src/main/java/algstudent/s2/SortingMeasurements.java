...
public class SortingMeasurements {
	private static int differentSizes = 100; //how many sizes do you want to use in the measurements 
	private static int nTimes = 1000; //number of repetitions of the executions
